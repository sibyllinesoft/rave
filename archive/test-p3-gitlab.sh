...
if nix-instantiate --parse /home/nathan/Projects/rave/nixos/gitlab.nix >/dev/null 2>&1; then
    test_result "GitLab module syntax" "PASS"
else
    test_result "GitLab module syntax" "FAIL" "Syntax errors in nixos/gitlab.nix"
fi

if nix-instantiate --parse /home/nathan/Projects/rave/nixos/configuration.nix >/dev/null 2>&1; then
    test_result "NixOS configuration syntax" "PASS"
else
    test_result "NixOS configuration syntax" "FAIL" "Syntax errors in nixos/configuration.nix"
fi
...
if grep -q "gitlab" /home/nathan/Projects/rave/nixos/gitlab.nix; then
    if grep -q "ensureDatabases.*gitlab" /home/nathan/Projects/rave/nixos/gitlab.nix; then
...
if grep -q "MemoryMax.*8G" /home/nathan/Projects/rave/nixos/gitlab.nix; then
...
expected_files=(
    ...
    "/home/nathan/Projects/rave/nixos/configuration.nix"
    "/home/nathan/Projects/rave/nixos/gitlab.nix"
    "/home/nathan/Projects/rave/nixos/prometheus.nix"
    "/home/nathan/Projects/rave/nixos/grafana.nix"
...
if grep -q "gitlab" /home/nathan/Projects/rave/nixos/prometheus.nix; then
...
if grep -q "privileged.*true" /home/nathan/Projects/rave/nixos/gitlab.nix; then
...
if grep -q "/dev/kvm" /home/nathan/Projects/rave/nixos/gitlab.nix; then
